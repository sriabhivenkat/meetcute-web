    ...
    return(
        <>
            ...
            <div className="advertisingContainer2">
                    <h2 style={{fontFamily: "Inter", fontSize: 40, marginLeft: 20, marginBottom: 50}}>
                        here's how it works.
                    </h2>
                    <div className="cardContainers">
                        <div className="cards">
                            <h1 style={{color: "white", fontSize: 40, textAlign: "center"}}>bring more foot traffic to your business.</h1>
                            <h4 style={{color: "white", marginTop: 20, fontWeight: "300"}}>the different kinds of adventures are shown on a grid. by partnering with us, you can display an adventure related to your brand that people are sure to try.</h4>
                    ...
                    <div className="cardContainers">
                        <div className="cards">
                            <h1 style={{color: "white", fontSize: 40}}>generate revenue at Meetcute Festivals.</h1>
